        ...
        <div className="function-metrics-container">
          ...
          <div className="all-metrics">
            <div className="summary-metric one">
              ...
              <h1>
                <ColdStartPercentage data={comparisonData} />
              </h1>
            </div>
            <div className="summary-metric">
              <p>Average Latency Weekly Change</p>
              <h1>
                <SpeedPerformance data={comparisonData} />
              </h1>
            </div>
            <div className="summary-metric">
              ...
              <h1>
                {comparisonData[0]
                  ? `${numFormat.format(comparisonData[0]['maxLatency'])} ms`
                  : '-'}
              </h1>
              <p className="bottom-p">
                {' '}
                {comparisonData[0]
                  ? `for function '${comparisonData[0]['maxLatFunc']}'`
                  : ''}
              </p>
            </div>
          </div>
          <div className="function-metrics">
            <div className="chart-container">
              <div className="data-header">
                <p className="chart-title">Average Lantency by Function</p>
              </div>
              {data ? (
            ...
            <div className="chart-container two">
              <div className="data-header">
                <p className="chart-title">Total Average Latency</p>
              </div>
              {data ? (
                <OverviewPanel
